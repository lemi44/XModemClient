...
namespace XModemClient
{
    public static class CRC
    {
        ...
        public static bool Sprawdz(byte[] paczka, byte[] CRC)
        {
            ushort CRCtoCheck = BitConverter.ToUInt16(Policz(paczka),0);
            ushort RealCRC = BitConverter.ToUInt16(CRC, 0);
            return !(Convert.ToBoolean(CRCtoCheck ^ RealCRC));
        }
    }
}
